...
nnoremap <silent> fe :<C-u>VimFiler -find -project<CR>
"let g:vimfiler_data_directory = $VARPATH.'/vimfiler'

"let g:vimfiler_as_default_explorer = 1
"let g:vimfiler_restore_alternate_file = 1
"let g:vimfiler_expand_jump_to_first_child = 0
let g:veimfiler_tree_leaf_icon = '├'
...
let g:vimfiler_ignore_pattern =
	\ '^\%(\.git\|\.logs\|\.temp\|\.github\|build\|node_modules\|.*\.pyc\)$'

let g:vimfiler_quick_look_command = 'gloobus-preview'
" install gloobus-preview first
" install vimproc
" in vim/.vim/ftplugin/vimfiler.vim
